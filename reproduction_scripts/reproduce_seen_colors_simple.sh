...
python cliport/train.py train.task=towers-of-hanoi-seq-seen-colors \
                        ...
                        dataset.cache=False | tee -a reproduction_logs/cliport_simple_train_n${N_DEMOS}.txt
...
python cliport/eval.py eval_task=towers-of-hanoi-seq-seen-colors \
                       ...
                       exp_folder=exps | tee -a reproduction_logs/cliport_simple_eval_n${N_DEMOS}.txt